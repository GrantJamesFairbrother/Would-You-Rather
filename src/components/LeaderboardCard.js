      ...
      <div
        ...
        <div className='card flex-md-row mb-4 shadow-sm h-md-250'>
          ...
          <div className='card-body d-flex flex-column align-items-start'>
            ...
            <h3 className='mb-0'>Answered Questions: {numQuestions}</h3>
            <hr />
            <h3 className='mb-0'>Created Questions: {numAnswers}</h3>
          </div>
          <div className='card col-md-3 col-12 p-0 m-1'>
            <div className='card-header bg-primary white-text '>
              <h5 className='text-center'>Score</h5>
            </div>
            <div className='card-body '>
              <div className='row'>
                <div className='badge badge-success badge-pill p-md-5 center'>
                  {total}
                </div>
              </div>
            </div>
